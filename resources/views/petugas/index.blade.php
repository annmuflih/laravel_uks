                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    @csrf
                                    @method('delete')
                                        <a href="{{route('petugas.show', $row->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                        <a href="{{route('petugas.edit', $row->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
