...
<div class="card-footer text-center">
    <a class="m-0 small text-primary card-link" href="/info">View More <i class="fas fa-chevron-right"></i></a>
</div>
</div>
</div> --}}
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            ...
                            <span class="badge bg-success" style="color: white"><i class="fas fa-check"></i>
                                Tersedia</span>
                            @else
                            <span class="badge bg-danger" style="color: white"><i class="fas fa-times"></i> Tidak
                                Tersedia</span>
                            @endif
                        </td>
                        <td><a href="/obat" class="btn btn-sm btn-primary">Detail</a></td>
